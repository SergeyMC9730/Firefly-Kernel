...
PANIC_M PM_ACPI_NOT_SUPPORTED  = "ACPI_NOT_SUPPORTED";
PANIC_M PM_RSDP_NOT_FOUND      = "RSDP_NOT_FOUND";
...
PANIC_C PC_ACPI_NOT_SUPPORTED  = 0x12000000;
PANIC_C PC_RSDP_NOT_FOUND      = 0x12100000;
